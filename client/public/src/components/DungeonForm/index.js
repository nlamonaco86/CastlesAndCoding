        ...
        <form>
            <div class="form-row vt-md">
                <div class="form-group col-md-12">
                    <label for="name">Dungeon Name</label>
                    <input type="email" class="form-control bg-dark text-white" id="name" placeholder="Dungeon Name"></input>
                </div>
            </div>
            <div class="form-row vt-md">
                <div class="form-group col-md-12">
                    <label for="description">Description</label>
                    <input type="number" class="form-control bg-dark text-white" id="desciption" placeholder="Describe the Dungeon..."></input>
                </div>
            </div>
            <div class="form-row vt-md">
                <div class="form-group col-md-6">
                    <label for="dungeonLevel">Dungeon Level</label>
                    <input type="number" class="form-control bg-dark text-white" id="dungeonLevel" placeholder="Level"></input>
                </div>
                <div class="form-group col-md-6">
                    <label for="bonus gold">Bonus Gold</label>
                    <input type="dungeonGold" class="form-control bg-dark text-white" id="dungeonGold" placeholder="Gold"></input>
                </div>
            </div>
            <div class="form-row vt-md">
